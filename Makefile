### Makefile --- Ubuntu 20.04 setup

## Author: thackl@lim4.de
## Version: $Id: Makefile,v1.0 2022/02/17 08:53:04 thackl Exp $
## Adopted for 20.04 and yaxha Install
...
tuxedo:
	sudo cp tuxedocomputers.list /etc/apt/sources.list.d/.
